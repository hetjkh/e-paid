  ...
  return (
    <section className="bg-background py-16 lg:py-24">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="overflow-hidden rounded-[28px] border border-border-soft bg-gradient-to-br from-[#e6f3fa] via-background to-[#fef8eb] p-6 shadow-[0_8px_40px_rgba(4,113,173,0.08)] dark:from-[#131e32] dark:via-[#111d32] dark:to-[#0f1a2e] dark:shadow-[0_8px_40px_rgba(4,113,173,0.15)] lg:p-10 xl:p-14">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16 xl:gap-20">
            <div className="mx-auto w-full max-w-[560px] lg:mx-0 lg:max-w-none">
              <div className="overflow-hidden rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
                <Image
                  src="/partner.png" alt="ePaid and Satocci partnership signing ceremony in Riyadh, Saudi Arabia" width={640}
                  height={640}
                  className="aspect-square h-auto w-full object-cover" sizes="(max-width: 1024px) 100vw, 50vw"/>
              </div>
            </div>

            <div className="flex flex-col justify-center">
              <h2 className="text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-[2.5rem]">
                ePaid 💙 Satocci
              </h2>
