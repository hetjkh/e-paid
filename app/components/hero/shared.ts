...
export const heroCtaClassName =
  "btn-glow inline-flex w-full items-center justify-center gap-2 rounded-full border-[3px] border-solid border-epaid bg-epaid py-2.5 pl-5 pr-1.5 text-xs font-semibold uppercase leading-none tracking-normal text-white sm:w-auto sm:justify-start sm:py-2 sm:pl-7 sm:pr-2 sm:text-sm lg:gap-3 lg:py-2 lg:pl-8 lg:text-base";
